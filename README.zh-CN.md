...
│  daemon / curator / Agent Stream Loop · Memory · Takeover │
...
- **AxionCLI** — 命令行入口，包含 agent stream loop、记忆系统、技能系统（Prompt + 录制 + 内置）、Daemon 管理、服务器模式、自进化和完成通知
...
│   └── Services/          # RunOrchestrator, AgentBuilder 和共享服务
├── AxionCore/             # 共享核心层
