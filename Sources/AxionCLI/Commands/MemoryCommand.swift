...
struct MemoryCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [MemoryListCommand.self, MemoryClearCommand.self, MemoryShowCommand.self, MemoryExportCommand.self, MemoryImportCommand.self, MemoryLearnTakeoverCommand.self]
    )
}
